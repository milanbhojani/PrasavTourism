    ...
    <div className="container">
      ...
      <div className="location-slider-wrapper" id="location-slider-wrapper">
        ...
        <div className="location-card style-1 wow fadeInUp" data-wow-delay="0s">
          <div className="image-wrapper">
            <a className="image-inner" href="destination-details.html">
              <img src="images/location-card/img1.jpg" alt="Location Image" loading="lazy" />
            </a>
            <div className="rating">
              <div className="ratting-inner">
                ...
                <span className="counter">6.5</span>
              </div>
            </div>
          </div>
          <div className="content-wrapper">
        ...
        >
          <div className="image-wrapper">
            <a href="destination-details.html" className="image-inner">
              <img src="images/location-card/img2.jpg" loading="lazy" alt="Location Image" />
            </a>
            <div className="rating">
              <div className="ratting-inner">
                <span>
        ...
        >
          <div className="image-wrapper">
            <a href="destination-details.html" className="image-inner">
              <img src="images/location-card/img3.jpg" loading="lazy" alt="Location Image" />
            </a>
            <div className="rating">
              <div className="ratting-inner">
                <span>
        ...
        >
          <div className="image-wrapper">
            <a href="destination-details.html" className="image-inner">
              <img src="images/location-card/img4.jpg" loading="lazy" alt="Location Image" />
            </a>
            <div className="rating">
              <div className="ratting-inner">
                <span>
        ...
        <div className="location-card style-1 wow fadeInUp" data-wow-delay="0s">
          <div className="image-wrapper">
            <a className="image-inner" href="destination-details.html">
              <img src="images/location-card/img5.jpg" loading="lazy" alt="Location Image" />
            </a>
            <div className="rating">
              <div className="ratting-inner">
                <span>
        ...
        >
          <div className="image-wrapper">
            <a href="destination-details.html" className="image-inner">
              <img src="images/location-card/img6.jpg" loading="lazy" alt="Location Image" />
            </a>
            <div className="rating">
              <div className="ratting-inner">
                <span>
        ...
        >
          <div className="image-wrapper">
            <a href="destination-details.html" className="image-inner">
              <img src="images/location-card/img7.jpg" loading="lazy" alt="Location Image" />
            </a>
            <div className="rating">
              <div className="ratting-inner">
                <span>
        ...
        >
          <div className="image-wrapper">
            <a href="destination-details.html" className="image-inner">
              <img src="images/location-card/img8.jpg" loading="lazy" alt="Location Image" />
            </a>
            <div className="rating">
              <div className="ratting-inner">
                <span>
